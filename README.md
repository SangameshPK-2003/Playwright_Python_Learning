...
This repository documents my **daily hands-on learning journey** in:

- Playwright with Python
- PyTest framework
- Real-world test automation structure
- QA engineering best practices

The goal is **consistent daily progress**, not perfection.
...
- Industry-style structure from the beginning  
- Fail → Understand → Improve  
...
- API testing with Playwright / requests  
- CI/CD integration  
...
**Sangamesh Kardegouda**  
Daily learning toward becoming a **professional QA Automation Engineer**.
